        ...
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header">
              <h4 className="modal-title">Welcome to Expense Management</h4>
            </div>
            <div className="modal-body">
              <span className="text-secondary text-justify">
                The Expense management app provides businesses with a
                streamlined solution to track, manage, and optimize their
